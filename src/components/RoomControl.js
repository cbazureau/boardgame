...
const RoomControls = ({ toggleVideo, toggleAudio, isAudioEnabled, isVideoEnabled, handleHangup, status }) => (
	<div className="RoomControls">
		...
		<button onClick={toggleVideo} className="RoomControls__control">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
				{!isVideoEnabled && (
					<path
						className="on"
		...
		{status === STATUS.ESTABLISHED && (
			<button onClick={handleHangup} className="RoomControls__control">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
					<path
